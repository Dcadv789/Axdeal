...
import { STATUS_PROPOSTAS, STATUS_PEDIDOS_VENDA, STATUS_ORDENS_SERVICO } from './PropostasContent/FilterBar';
import MultiSelectDropdown from './PropostasContent/MultiSelectDropdown';
import DateRangePicker from './PropostasContent/DateRangePicker';
import { normalizarStatusParaLookup } from '@/config/propostas';
import PropostasTable, { type NegociosTableColumnKey } from './PropostasContent/PropostasTable';
import KanbanView from './PropostasContent/KanbanView';
import ModalAlterarStatusProposta from './PropostasContent/ModalAlterarStatusProposta';
import ModalConfirmarExclusao from './PropostasContent/ModalConfirmarExclusao';
import ModalConfirmarMovimentoEstoque from './PropostasContent/ModalConfirmarMovimentoEstoque';
