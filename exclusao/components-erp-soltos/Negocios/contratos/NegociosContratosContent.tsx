...
import DateRangePicker from '@/components/erp/PropostasContent/DateRangePicker';
import MultiSelectDropdown from '@/components/erp/PropostasContent/MultiSelectDropdown';
...
} from '@/components/erp/NegociosContratosTable';
