...
CREATE INDEX IF NOT EXISTS idx_crm_leads_utm_medium ON public.crm_leads(utm_medium);
...
'View consolidada de leads para relatorios CRM (lead + quiz + pipeline + etapa + UTM + agregados de respostas).';
