/*
  View consolidada para relatórios de leads CRM
...
'View consolidada de leads para relatórios CRM (lead + quiz + pipeline + etapa + agregados de respostas).';
