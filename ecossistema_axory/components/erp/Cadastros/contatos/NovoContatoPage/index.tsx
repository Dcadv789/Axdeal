...
export default function NovoClientePage({
  ...
  const displayName =
    formData.nome.trim() || (mode === 'create' ? 'Novo contato' : 'Contato sem identificação');
            ...
            <div className="mb-6 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  Dados principais do contato e documento fiscal.
                </p>
              </div>
            </div>
        ...
        {activeTab === 'detalhes' && (
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Dados complementares do contato e informações cadastrais.
              </p>
            </div>
        ...
        {activeTab === 'endereco' && (
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Localização e dados logísticos do contato.
              </p>
            </div>
        ...
        {activeTab === 'financeiro' && (
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Estrutura reservada para dados financeiros do contato.
              </p>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <FutureBlock
                ...
                description="Espaço preparado para política de crédito e exposição total do contato."
              />
              <FutureBlock
        ...
        {activeTab === 'historico' && (
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Contexto comercial e observações relevantes do contato.
              </p>
            </div>
            ...
            <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="space-y-4">
                <SummaryCard
                  ...
                  value="Integração preparada para conectar pedidos e propostas desse contato."
