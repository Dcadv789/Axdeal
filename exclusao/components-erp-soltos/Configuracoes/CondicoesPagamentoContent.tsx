        ...
        <div className="rounded-xl border border-slate-200 dark:border-neutral-700 bg-white dark:bg-neutral-900/50 p-5">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-slate-200 dark:bg-neutral-700 rounded-lg animate-pulse" />
              <div className="space-y-2">
                <div className="h-4 w-48 bg-slate-200 dark:bg-neutral-700 rounded animate-pulse" />
                <div className="h-3 w-64 bg-slate-200 dark:bg-neutral-700 rounded animate-pulse" />
              </div>
            </div>
            <div className="h-10 w-36 bg-slate-200 dark:bg-neutral-700 rounded-lg animate-pulse" />
          </div>
              ...
              {condicoes.map((condicao, idx) => (
                <tr
                  ...
                  className={`hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors ${
                    idx !== condicoes.length - 1 ? 'border-b border-slate-200 dark:border-neutral-700' : ''
                  }`}
                >
                  <td className="px-6 py-4">
