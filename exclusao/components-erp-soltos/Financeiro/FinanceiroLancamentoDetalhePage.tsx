...
import FinanceiroBaixaLancamentoPanel, { type AbaInterna, type BaixaDraft, type ParcelaLite } from '@/components/erp/FinanceiroBaixaLancamentoPanel';
import DatePickerPT from '@/components/erp/NovaPropostaPage/components/DatePickerPT';
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button type="button" onClick={() => router.push('/erp/cadastros/clientes')} className="inline-flex h-10 shrink-0 items-center gap-1 rounded-xl border border-blue-200 bg-blue-50 px-3 text-sm font-semibold text-blue-700 transition-colors hover:bg-blue-100 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-300 dark:hover:bg-blue-500/20">
